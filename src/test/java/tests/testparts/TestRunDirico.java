...
//                .until(ExpectedConditions.presenceOfElementLocated(By.linkText("LOGINs")));
//        login.click();
...
//        }
        ...
        findElementWithDelay(20, By.name("username")).click();
        findElementWithDelay(20, By.name("username")).sendKeys("christian.schmitz@dirico.io");
        {
            Actions builder = new Actions(driver);
            builder
                    .moveToElement(findElementWithDelay(20, By.cssSelector(".jss290 > .jss268")))
                    .perform();
        ...
        {
            Actions builder = new Actions(driver);
            builder.moveToElement(findElementWithDelay(20, By.cssSelector(".MuiListItem-selected-138")))
                    .perform();

        }
        {
            Actions builder = new Actions(driver);
            builder.moveToElement(findElementWithDelay(20, By.tagName("body")), 0, 0)
                    .perform();
        }
//        js.executeScript("window.scrollTo(0,0)");
    ...
    private WebElement findElementWithDelay(long timeOut, By locator) {
