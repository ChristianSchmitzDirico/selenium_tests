package test.examples.pageobjectexample;
...
public class LoginPageExample extends BasePage {
    ...
    public LoginPageExample loginToN11 (String username, String password){
    ...
    public LoginPageExample verifyLoginUserName (String expectedText) {
        assertEquals(errorMessageUsernameBy, expectedText);
        return this;
    }

    //Verify Password Condition
    public LoginPageExample verifyLoginPassword (String expectedText) {
